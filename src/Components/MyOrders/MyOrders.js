...
const MyOrders = () => {
    ...
    useEffect(() => {
        fetch(`https://secret-sierra-31961.herokuapp.com/orders/${email}`)
            .then(res => res.json())
    ...
    const handleDeleteOrder = (id) => {
        ...
        if (proceed) {
            fetch(`https://secret-sierra-31961.herokuapp.com/deleteOrders/${id}`, {
                method: 'DELETE',
                headers: {
            ...
            </div>
            {
                orders.map((order, index) => < div className="container mx-auto text-center " >
                    <table class="table text-primary">
                        ...
                        <tbody>
                            <tr>
                                <th scope="row align-items-center"><img src={order.img} width='50' className='img-fluid border' alt="" /></th>
